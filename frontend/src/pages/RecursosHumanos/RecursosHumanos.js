            ...
            <form onSubmit={(event) => handleColaboradorSubmit(event, 'colaborador')}>
                ...
                <div>
                    ...
                    <input
                        ...
                        onChange={(event) => handleColaboradorInputChange(event, 'ficha')} // Certifique-se de usar o tipo correto
                    />
                ...
                <div>
                    ...
                    <div className="modal" id="modalAtividade">
                        <div className="modal-content">
                            <span className="close-button" onClick={() => closeModal('modalAtividade')}>
                                &times;
                            </span>
                    ...
                    <div className="modal" id="modalColaborador">
                        <div className="modal-content">
                            <span className="close-button" onClick={() => closeModal('modalColaborador')}>
                                &times;
                            </span>
